...
public class ApplicationConfig {
    ...
    public LocalSessionFactoryBean sessionFactory() {
        ...
        sessionFactory.setPackagesToScan("com.qiaohui.jupiter.entity.db");
    ...
    public DataSource dataSource() {
        String RDS_ENDPOINT = "chloe-twitch.cudh81mfdxie.us-east-2.rds.amazonaws.com";
        String USERNAME = "admin";
        String PASSWORD = "971217zqh";
